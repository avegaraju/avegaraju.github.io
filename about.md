...
layout: page
title: About Me
description: Senior backend engineer focused on building scalable systems and sharing practical engineering insight.
---

<div class="about-intro">
    <div class="about-profile">
        <img src="https://github.com/{{ site.github_username }}.png" alt="{{ site.title }}" class="about-avatar">
        <div class="about-info">
            <h2>Hi, I'm Ashish Vegaraju.</h2>
            <p>I'm a senior backend engineer and technical leader with close to two decades of experience building and operating software systems at scale. I work primarily in backend engineering and system architecture, with a strong focus on building reliable, scalable platforms that hold up under real-world complexity.</p>
        </div>
    </div>
</div>
...
<div class="cta-section">
    ...
    <div class="social-connect">
        ...
        <a href="https://www.linkedin.com/in/avegaraju/" target="_blank" rel="noopener">LinkedIn</a>
    </div>
</div>